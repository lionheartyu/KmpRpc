...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_rpchearder_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_rpchearder_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_rpchearder_2eproto = nullptr;

const uint32_t TableStruct_rpchearder_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_rpchearder_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020rpchearder.proto\022\005mprpc\"I\n\tRpcHeader\022\024"
  "\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001("
  "\014\022\021\n\targs_size\030\003 \001(\rb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_rpchearder_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpchearder_2eproto = {
  false, false, 108, descriptor_table_protodef_rpchearder_2eproto, "rpchearder.proto", 
  &descriptor_table_rpchearder_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_rpchearder_2eproto::offsets,
  file_level_metadata_rpchearder_2eproto, file_level_enum_descriptors_rpchearder_2eproto, file_level_service_descriptors_rpchearder_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_rpchearder_2eproto_getter() {
  return &descriptor_table_rpchearder_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_rpchearder_2eproto(&descriptor_table_rpchearder_2eproto);
namespace mprpc {
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHeader::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_rpchearder_2eproto_getter, &descriptor_table_rpchearder_2eproto_once,
      file_level_metadata_rpchearder_2eproto[0]);
}
