...
class FriendServicerRpc_Stub;

class FriendServicerRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline FriendServicerRpc() {};
 public:
  virtual ~FriendServicerRpc();

  typedef FriendServicerRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendServicerRpc);
};

class FriendServicerRpc_Stub : public FriendServicerRpc {
 public:
  FriendServicerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  FriendServicerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~FriendServicerRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements FriendServicerRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendServicerRpc_Stub);
};
