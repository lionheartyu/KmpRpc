...
class RegisterRespose;
struct RegisterResposeDefaultTypeInternal;
extern RegisterResposeDefaultTypeInternal _RegisterRespose_default_instance_;
class ResultCode;
...
template<> ::fixbug::LoginRespose* Arena::CreateMaybeMessage<::fixbug::LoginRespose>(Arena*);
template<> ::fixbug::RegisterRequest* Arena::CreateMaybeMessage<::fixbug::RegisterRequest>(Arena*);
template<> ::fixbug::RegisterRespose* Arena::CreateMaybeMessage<::fixbug::RegisterRespose>(Arena*);
...
class LoginRespose final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LoginRespose) */ {
 public:
  ...
  LoginRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  // @@protoc_insertion_point(class_scope:fixbug.LoginRespose)
 private:
  class _Internal;
...
class RegisterRespose final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegisterRespose) */ {
 public:
  inline RegisterRespose() : RegisterRespose(nullptr) {}
  ~RegisterRespose() override;
  explicit constexpr RegisterRespose(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RegisterRespose(const RegisterRespose& from);
  RegisterRespose(RegisterRespose&& from) noexcept
    : RegisterRespose() {
    *this = ::std::move(from);
  }

  inline RegisterRespose& operator=(const RegisterRespose& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegisterRespose& operator=(RegisterRespose&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const RegisterRespose& default_instance() {
    return *internal_default_instance();
  }
  static inline const RegisterRespose* internal_default_instance() {
    return reinterpret_cast<const RegisterRespose*>(
               &_RegisterRespose_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(RegisterRespose& a, RegisterRespose& b) {
    a.Swap(&b);
  }
  inline void Swap(RegisterRespose* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(RegisterRespose* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  RegisterRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RegisterRespose>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const RegisterRespose& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const RegisterRespose& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegisterRespose* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegisterRespose";
  }
  protected:
  explicit RegisterRespose(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegisterRespose)
 private:
  class _Internal;
...
class UserServicerRpc_Stub;

class UserServicerRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline UserServicerRpc() {};
 public:
  virtual ~UserServicerRpc();

  typedef UserServicerRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServicerRpc);
};

class UserServicerRpc_Stub : public UserServicerRpc {
 public:
  UserServicerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  UserServicerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~UserServicerRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements UserServicerRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServicerRpc_Stub);
};
...
inline const ::fixbug::ResultCode& LoginRespose::_internal_result() const {
...
inline const ::fixbug::ResultCode& LoginRespose::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRespose.result)
  return _internal_result();
}
inline void LoginRespose::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginRespose.result)
}
inline ::fixbug::ResultCode* LoginRespose::release_result() {
...
inline ::fixbug::ResultCode* LoginRespose::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRespose.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginRespose::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* LoginRespose::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRespose.result)
  return _msg;
}
inline void LoginRespose::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRespose.result)
}

// bool sucess = 2;
inline void LoginRespose::clear_sucess() {
  sucess_ = false;
}
inline bool LoginRespose::_internal_sucess() const {
  return sucess_;
}
inline bool LoginRespose::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRespose.sucess)
  return _internal_sucess();
}
inline void LoginRespose::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void LoginRespose::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginRespose.sucess)
}
...
// .fixbug.ResultCode result = 1;
inline bool RegisterRespose::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool RegisterRespose::has_result() const {
  return _internal_has_result();
}
inline void RegisterRespose::clear_result() {
  if (GetArenaForAllocation() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& RegisterRespose::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& RegisterRespose::result() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRespose.result)
  return _internal_result();
}
inline void RegisterRespose::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterRespose.result)
}
inline ::fixbug::ResultCode* RegisterRespose::release_result() {
...
inline ::fixbug::ResultCode* RegisterRespose::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterRespose.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* RegisterRespose::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* RegisterRespose::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterRespose.result)
  return _msg;
}
inline void RegisterRespose::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterRespose.result)
}

// bool sucess = 2;
inline void RegisterRespose::clear_sucess() {
  sucess_ = false;
}
inline bool RegisterRespose::_internal_sucess() const {
  return sucess_;
}
inline bool RegisterRespose::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRespose.sucess)
  return _internal_sucess();
}
inline void RegisterRespose::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void RegisterRespose::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRespose.sucess)
}
