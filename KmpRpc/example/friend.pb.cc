...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ervicerRpc\022O\n\016GetFriendsList\022\035.fixbug.Ge"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  false, false, 304, descriptor_table_protodef_friend_2eproto, "friend.proto", 
...
FriendServicerRpc::~FriendServicerRpc() {}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServicerRpc::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServicerRpc::GetDescriptor() {
  return descriptor();
}

void FriendServicerRpc::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void FriendServicerRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServicerRpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServicerRpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
FriendServicerRpc_Stub::FriendServicerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
FriendServicerRpc_Stub::FriendServicerRpc_Stub(
...
void FriendServicerRpc_Stub::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
