...
namespace fixbug {
class GetfFriendListsRequest;
struct GetfFriendListsRequestDefaultTypeInternal;
extern GetfFriendListsRequestDefaultTypeInternal _GetfFriendListsRequest_default_instance_;
class GetfFriendListsRespose;
struct GetfFriendListsResposeDefaultTypeInternal;
extern GetfFriendListsResposeDefaultTypeInternal _GetfFriendListsRespose_default_instance_;
class LoginRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetfFriendListsRequest* Arena::CreateMaybeMessage<::fixbug::GetfFriendListsRequest>(Arena*);
template<> ::fixbug::GetfFriendListsRespose* Arena::CreateMaybeMessage<::fixbug::GetfFriendListsRespose>(Arena*);
...
class GetfFriendListsRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetfFriendListsRequest) */ {
 public:
  inline GetfFriendListsRequest() : GetfFriendListsRequest(nullptr) {}
  ~GetfFriendListsRequest() override;
  explicit constexpr GetfFriendListsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetfFriendListsRequest(const GetfFriendListsRequest& from);
  GetfFriendListsRequest(GetfFriendListsRequest&& from) noexcept
    : GetfFriendListsRequest() {
    *this = ::std::move(from);
  }

  inline GetfFriendListsRequest& operator=(const GetfFriendListsRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetfFriendListsRequest& operator=(GetfFriendListsRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetfFriendListsRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetfFriendListsRequest* internal_default_instance() {
    return reinterpret_cast<const GetfFriendListsRequest*>(
               &_GetfFriendListsRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetfFriendListsRequest& a, GetfFriendListsRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetfFriendListsRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetfFriendListsRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetfFriendListsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetfFriendListsRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetfFriendListsRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const GetfFriendListsRequest& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetfFriendListsRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetfFriendListsRequest";
  }
  protected:
  explicit GetfFriendListsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetfFriendListsRequest)
 private:
  class _Internal;
...
class GetfFriendListsRespose final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetfFriendListsRespose) */ {
 public:
  inline GetfFriendListsRespose() : GetfFriendListsRespose(nullptr) {}
  ~GetfFriendListsRespose() override;
  explicit constexpr GetfFriendListsRespose(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetfFriendListsRespose(const GetfFriendListsRespose& from);
  GetfFriendListsRespose(GetfFriendListsRespose&& from) noexcept
    : GetfFriendListsRespose() {
    *this = ::std::move(from);
  }

  inline GetfFriendListsRespose& operator=(const GetfFriendListsRespose& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetfFriendListsRespose& operator=(GetfFriendListsRespose&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetfFriendListsRespose& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetfFriendListsRespose* internal_default_instance() {
    return reinterpret_cast<const GetfFriendListsRespose*>(
               &_GetfFriendListsRespose_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetfFriendListsRespose& a, GetfFriendListsRespose& b) {
    a.Swap(&b);
  }
  inline void Swap(GetfFriendListsRespose* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetfFriendListsRespose* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetfFriendListsRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetfFriendListsRespose>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetfFriendListsRespose& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const GetfFriendListsRespose& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetfFriendListsRespose* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetfFriendListsRespose";
  }
  protected:
  explicit GetfFriendListsRespose(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetfFriendListsRespose)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetfFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class UserServiceRpc_Stub : public UserServiceRpc {
 public:
  ...
  void Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::fixbug::LoginResponse* response,
                       ::google::protobuf::Closure* done);
  void GetfFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::GetfFriendListsRequest* request,
                       ::fixbug::GetfFriendListsRespose* response,
                       ::google::protobuf::Closure* done);
 private:
...
// uint32 userid = 1;
inline void GetfFriendListsRequest::clear_userid() {
  userid_ = 0u;
}
inline uint32_t GetfFriendListsRequest::_internal_userid() const {
  return userid_;
}
inline uint32_t GetfFriendListsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetfFriendListsRequest.userid)
  return _internal_userid();
}
inline void GetfFriendListsRequest::_internal_set_userid(uint32_t value) {
  
  userid_ = value;
}
inline void GetfFriendListsRequest::set_userid(uint32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetfFriendListsRequest.userid)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetfFriendListsRespose::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetfFriendListsRespose::has_result() const {
  return _internal_has_result();
}
inline void GetfFriendListsRespose::clear_result() {
  if (GetArenaForAllocation() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetfFriendListsRespose::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetfFriendListsRespose::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetfFriendListsRespose.result)
  return _internal_result();
}
inline void GetfFriendListsRespose::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetfFriendListsRespose.result)
}
inline ::fixbug::ResultCode* GetfFriendListsRespose::release_result() {
...
inline ::fixbug::ResultCode* GetfFriendListsRespose::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetfFriendListsRespose.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetfFriendListsRespose::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetfFriendListsRespose::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetfFriendListsRespose.result)
  return _msg;
}
inline void GetfFriendListsRespose::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetfFriendListsRespose.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetfFriendListsRespose::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetfFriendListsRespose::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetfFriendListsRespose::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetfFriendListsRespose::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetfFriendListsRespose.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetfFriendListsRespose::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetfFriendListsRespose.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetfFriendListsRespose::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetfFriendListsRespose::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetfFriendListsRespose.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetfFriendListsRespose::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetfFriendListsRespose::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetfFriendListsRespose.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetfFriendListsRespose::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetfFriendListsRespose.friend_list)
  return friend_list_;
}
